...
define("frontend/tests/unit/models/recipe-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";
...
define("frontend/tests/unit/routes/recipe-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | recipe', function (hooks) {
